 <header class="main-header">
    ...
    <a href="dashboard" class="logo">
      ...
      <span class="logo-lg"><b>19php01</b> Laravel</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="uploads/hii.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="uploads/hii.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                    ...
                    <a class="btn btn-default btn-flat" class="dropdown-item" href="{{ route('logout') }}"
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admin/users/add_users"><i class="fa fa-circle-o"></i> Add user</a></li>
            <li><a href="admin/users/list_users"><i class="fa fa-circle-o"></i> List user</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin/products/add_products"><i class="fa fa-circle-o"></i> Add products</a></li>
            <li><a href="admin/products/list_products"><i class="fa fa-circle-o"></i> List products</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin/blog/add_blog"><i class="fa fa-circle-o"></i> Add blog</a></li>
            <li><a href="admin/blog/list_blog"><i class="fa fa-circle-o"></i> List blog</a></li>
          
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Comment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="admin/pages/forms/general.html"><i class="fa fa-circle-o"></i> comment_news</a></li>
            <li><a href="admin/pages/forms/advanced.html"><i class="fa fa-circle-o"></i> comment_products</a></li>
